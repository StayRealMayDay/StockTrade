	...
	<div id="main-content">
		<div class="primary" style="width:780px;float:left">
			<article class="entry-item">
				<header>
					<span class="entry-author">${cbNewsDetail.newsSource }</span>
					<span class="entry-date">&nbsp;&nbsp;|&nbsp;&nbsp;${cbNewsDetail.newsTime }</span>
					<h1 class="entry-title">${cbNewsDetail.title }</h1>					          
				</header>			
				<blockquote>${cbNewsDetail.newsContent }</blockquote>
			<div class="clear"></div>
			</article>       
				...
				<ul class="clearfix" style="border:0px">
					<li>
						<article class="clearfix">
							...
							<h6><a href="#">${cbNewsDetail.title }</a></h6>
						</article>
					</li>
					<li>
						<article class="clearfix">
