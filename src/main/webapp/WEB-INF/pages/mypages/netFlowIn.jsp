						...
						<div id="myTabContent2" class="tab-content">
								...
								<div role="tabpanel" class="tab-pane in active" id="leader" aria-labelledby="brief_tab">
									...
									<div class="box border purple">
										<div class="box-title">
											<h4><i class="fa fa-table"></i>净流入额</h4>
									...
									<div class="box-body">
										<table id="datatable1" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
											...
											<tbody>
												<c:forEach items="${netFlowIn}" var="v" varStatus="sta">
												<tr class="gradeX">
												    <td>${sta.index+1}</td>
...
//基于准备好的dom，初始化echarts实例
 ...
 var option = {
	    ...
	    xAxis: {
	        type: 'category',
	        boundaryGap: false,
	        data: ['宝钢股份','江粉磁材','南玻A','南钢股份','韶钢松山','林洋能源','科大讯飞','马钢股份','工商银行','太钢不锈']
	    },
	    yAxis: {
	        type: 'value'
	    },
	    series: [
	        
	        {
	            ...
	            type:'line',
	            stack: '总量',
	            data:[46905140,46899971,38997991,33855272,28362145,28162627,24905330,21782429,20742287,19287948]
	        }
