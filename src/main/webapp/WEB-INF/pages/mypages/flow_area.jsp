				...
				<div class="row">
					<div id="content" class="col-lg-12">
						<div class="row">
							<div class="col-sm-12">							
									<ul class="breadcrumb">
										<li><i class="fa fa-home"></i> <a href="#">地域流向>>></a>
										</li>
								...
								<div role="tabpanel" class="tab-pane in active" id="leader" aria-labelledby="brief_tab">
									...
									<div class="box-body">
										<table id="datatable1" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
											...
											<tbody>
												<c:forEach items="${capitalFlowsArea}" var="v" varStatus="sta">
												<tr class="gradeX">
												    <td>${sta.index+1}</td>
													<td><a href="#" title="点击查看行业详情">${v.company.companyArea}</a></td>
	    ...
	    series: [
	        {
	            ...
	            type:'line',
	            stack: '总量',
	            data:[42823562107,18031164547,14150596044,7048333446,42760595162,5774466437,10346312168,2694904260,4403782563,2248663177,1382813814,3157706270,558070915,1801571048,3065212596,460781831,523115745,351922128,660049803,2399408593,179499705,56809378,3680947827,1875157773,1236766663,3646946293,1612642268,2755928471,2561988613,10754209902,16591600119,1745612166]
	        },
	        {
	            name:'流入量',
	            type:'line',
	            stack: '总量',
	            data:[36968581622,17492096852,14174934942,6300867211,44259159094,5025157116,10372959441,2110101213,4188114819,1990315171,1278305601,3088160294,509357956,1597681893,2513494991,286453984,362639584,400056481,590228506,2045514556,161761059,37788652,4027483298,1812432908,1142788504,2566447716,1536684315,3155691763,3098027399,11873998092,17387402094,1803634713]
	        },
	        {
	            name:'净流入量',
	            type:'line',
	            stack: '总量',
	            data:[-547886706, -175197980, -101139025, -69197547, -68899667,-64324166,-51336145,-41135752,-36796014,-27007982,-24415307,-21931040,-20397612,-16623511,-15352598,-10395283,-8078446,-7075829,-5809372,-3905541,-3366089,-2222958,-1276425,-630218,-340418,637507,791930,2121156,4202553,11284074,18784443,32741197]
	        },
	        {
	            name:'金额流入率',
	            type:'line',
	            stack: '总量',
	            data:[-4.465073033707865,-3.2136445945945944,-1.833810638297872,-4.218678124999999,-2.725566458333334,-2.6631598290598286,-3.9634711111111094,-3.14475,-3.072735483870968,-5.1146512195121945,-5.38072894736842,-4.086722727272727,-4.170876923076923,-4.3272375,-4.5879770833333335,-5.335589655172414,-2.6245749999999997,-3.89233,-3.0932727272727276,-3.5258100000000003,-2.3363142857142853,-3.982309090909091,-3.3655090909090917,-4.3745,-5.85401,-5.864391428571428,-3.009848717948718,-3.2877624999999995,-3.3592761904761903,-3.8335854166666667,-2.1129748502994024,-2.1249114285714286]
	        }
	    ]
	};
	//使用刚指定的配置项和数据显示图表。
