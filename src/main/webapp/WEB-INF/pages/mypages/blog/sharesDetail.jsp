	...
	<div id="main-content">
		<div class="primary" style="width:780px;float:left">
			<article class="entry-item">
				<header>
					<span class="entry-author">${sharesDetail.author }</span>
					<span class="entry-date">&nbsp;&nbsp;|&nbsp;&nbsp;发贴时间：${sharesDetail.time }</span>
					<span class="entry-date">&nbsp;&nbsp;|&nbsp;&nbsp;点击数：${sharesDetail.clickNum }</span>
					<span class="entry-date">&nbsp;&nbsp;|&nbsp;&nbsp;相关股票：${sharesDetail.sharesName }</span>
					<h1 class="entry-title">${sharesDetail.sharesTitle }</h1>					          
				</header>			
				<blockquote>${sharesDetail.content }</blockquote>
			<div class="clear"></div>
			</article>       
				...
				<ul class="clearfix" style="border:0px">
					<li>
						<article class="clearfix">
							...
							<h6><a href="#">${sharesDetail.sharesTitle }</a></h6>
						</article>
					</li>
					<li>
						<article class="clearfix">
