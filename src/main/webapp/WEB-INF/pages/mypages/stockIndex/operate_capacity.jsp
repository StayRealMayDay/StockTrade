			...
			<div class="box border purple">
					...
					<div class="box-body">
						<table id="datatable1" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
							...
							<tbody>
								<c:forEach items="${operate_capacity}" var="v" varStatus="sta">
								<tr class="gradeX">
									<td><a href="company?stockNum=${fn:substring(v.stockCode,0,6)}">${v.stockName}</a></td>
									<td>${v.businessCycle }</td>
									<td>${v.netBussinessCycle }</td>
									<td>${v.cashCycleCycle }</td>
									<td>${v.inventoryTurnover }</td>
									<td>${v.accountsReceivableTurnoverRate }</td>
									<td>${v.accountsBillReceivableTurnover }</td>
									<td>${v.accountsPayableUrnoverRate }</td>
									<td>${v.mobileAssetsTurnoverRate }</td>
									<td>${v.notMobileAssetsTurnoverRate }</td>
									<td>${v.fixedAssetsTurnover }</td>
									<td>${v.totalAssetsTurnover }</td>
									<td>${v.operateAssetsTurnover }</td>
									<td>${v.netAssetsTurnover }</td>
