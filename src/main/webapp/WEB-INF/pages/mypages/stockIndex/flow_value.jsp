					...
					<div id="content" class="col-lg-12">
						...
						<table id="datatable1" cellpadding="0" cellspacing="0" border="0"
							...
							<tbody role="alert" aria-live="polite" aria-relevant="all">
								<c:forEach var="v" items="${allFlowValue}" varStatus="">
									<tr class="gradeA odd">
										<td class=" sorting_1"><input type="checkbox"></td>
										<td>${v.stockName}</td>
										<%-- <td class="hidden-xs ">${v.userUuid}</td> --%>
										<td >${v.stockCode}</td>
										<td ><font color="red">${v.flowMarketValue}</font></td>
									...
									<div class="dataTables_paginate paging_bs_full"
										...
										<ul class="pagination">
											...
											<li ${pager.pageNum==1?'class="disabled"':''}><a
												href="flow_value?stockNum=${stockNum}&pageNum=1">首页</a></li>
											<li ${pager.pageNum==1?'class="disabled"':''}><a
												href="flow_value?stockNum=${stockNum}&pageNum=${pager.pageNum-1 }">上页</a></li>
											<li ${pager.pageNum==pager.pageCount?'class="disabled"':''}><a
												href="flow_value?stockNum=${stockNum}&pageNum=${pager.pageNum+1 }">下页</a></li>
											<li ${pager.pageNum==pager.pageCount?'class="disabled"':''}><a
												href="flow_value?stockNum=${stockNum}&pageNum=${pager.pageCount }">末页</a></li>
											<li><a>转到 </a></li>
