			...
			<div class="box border purple">
					...
					<div class="box-body">
						<table id="datatable1" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
							...
							<tbody>
								<c:forEach items="${monthQuotation}" var="v" varStatus="sta">
								<tr class="gradeX">
									...
									<td>${v.lowest }</td>
									<td>${v.close }</td>
									<td>${v.highestClose }</td>
									<td>${v.lowestClose }</td>
									<td>${v.avePrice }</td>
									<td>${v.updownRatio }</td>
									<td>${v.turnVolume }</td>
									<td>${v.aveTurnoverRate }</td>
									<td>${v.amplitude }</td>
									<td>${v.overDapanDays }</td>
									<td>${v.highestCloseDate }</td>
									<td>${v.lowestCloseDate }</td>
									<td>${v.highestUpdownDate }</td>
									<td>${v.lowestUpdownDate }</td>
								</tr>
								</c:forEach>
							</tbody>
						</table>
