			...
			<div class="box border purple">
					...
					<div class="box-body">
						<table id="datatable1" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
							...
							<tbody>
								<c:forEach items="${du_pont_analysis}" var="v" varStatus="sta">
								<tr class="gradeX">
									<td><a href="company?stockNum=${fn:substring(v.stockCode,0,6)}">${v.stockName}</a></td>
									<td>${v.netAssetYield }</td>
									<td>${v.equityMultiplier }</td>
									<td>${v.totalAssetTurnover }</td>
									<td>${v.netProfitParentCompany }</td>
									<td>${v.netProfitTotalIncome }</td>
									<td>${v.netProfitTotalProfit }</td>
									<td>${v.totalProfitBeforeIncomeTax }</td>
									<td>${v.beforeIncomeTaxTotalIncome }</td>
								</tr>
