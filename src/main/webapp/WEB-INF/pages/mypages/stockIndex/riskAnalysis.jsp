...
<div >
	<div style="width:60%;margin-left:400px">
		<div style="height:1000px;float:left;width:100%">
		
			<div class="box border purple">
						<div class="box-title">
							<h4><i class="fa fa-table"></i>风险分析</h4>
					...
					<div class="box-body">
						<table id="datatable1" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
							...
							<tbody>
								<c:forEach items="${riskAnalysis}" var="v" varStatus="sta">
								<tr class="gradeX">
									<td>${v.stockCode}</td>
									<td>${v.stockName}</td>
									<td>${v.betaweek100}</td>
									<td>${v.betamonth24}</td>
									<td>${v.betamonth60}</td>
									<td>${v.annualizedReturnWeek100}</td>
									<td>${v.annualizedReturnMonth24}</td>
									<td>${v.annualizedReturnMonth60}</td>
									<td>${v.annualizedVolatilityWeek100}</td>
									<td>${v.annualizedVolatilityMonth24}</td>
									<td>${v.annualizedVolatilityMonth60}</td>
								</tr>
								</c:forEach>
							</tbody>
						</table>
