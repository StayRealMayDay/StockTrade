	...
	<div id="main-content">
		<div class="primary" style="width:780px;float:left">
			<article class="entry-item">
				<header>
					<span class="entry-author">${newsinfo.source }</span>
					<span class="entry-date">&nbsp;&nbsp;|&nbsp;&nbsp;${newsinfo.time }</span>
					<h1 class="entry-title">${newsinfo.title }</h1>					          
				</header>			
				<blockquote>${newsinfo.content }</blockquote>
			<div class="clear"></div>
			</article>       
