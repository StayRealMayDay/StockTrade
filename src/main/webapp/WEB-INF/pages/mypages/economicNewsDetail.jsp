	...
	<div id="main-content">
		<div class="primary" style="width:780px;float:left">
			<article class="entry-item">
				<header>
					<span class="entry-author">${eeoNewsDetail.author }</span>
					<span class="entry-date">&nbsp;&nbsp;|&nbsp;&nbsp;${eeoNewsDetail.newsTime }</span>
					<h1 class="entry-title">${eeoNewsDetail.title }</h1>					          
				</header>			
				<blockquote>${eeoNewsDetail.newsContent }</blockquote>
			<div class="clear"></div>
			</article>       
				...
				<ul class="clearfix" style="border:0px">
					<li>
						<article class="clearfix">
							...
							<h6><a href="#">${eeoNewsDetail.title }</a></h6>
						</article>
					</li>
					<li>
						<article class="clearfix">
