								...
								<div role="tabpanel" class="tab-pane in active" id="leader" aria-labelledby="brief_tab">
									...
									<div class="box-body">
										<table id="datatable1" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
											...
											<tbody>
												<c:forEach items="${moneyRate}" var="v" varStatus="sta">
												<tr class="gradeX">
												    <td>${sta.index+1}</td>
													...
													<td><font color="red">${v.dayFlowinRate}</font></td>
												</tr>
												</c:forEach>
											</tbody>
										</table>
...
//基于准备好的dom，初始化echarts实例
 ...
 var option = {
	    ...
	    xAxis: {
	        type: 'category',
	        boundaryGap: false,
	        data: ['合盛硅业','聚灿光电','阿科力','英可瑞','泰瑞机器','万盛股份','菲利华','同花顺','瑞贝卡','武汉控股']
	    },
	    yAxis: {
	        type: 'value'
	    },
	    series: [
	        
	        {
	            ...
	            type:'line',
	            stack: '总量',
	            data:[99.9635,99.6204,99.2050,98.6770,95.7997,9.8990,9.8718,9.8521,9.8090,9.8010]
	        }
