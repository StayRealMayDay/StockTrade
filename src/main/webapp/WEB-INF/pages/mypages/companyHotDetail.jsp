	...
	<div id="main-content">
		<div class="primary" style="width:780px;float:left">
			<article class="entry-item">
				<header>
					<span class="entry-author">${companyNewsDetail.newsSource }</span>
			...
			<div class="about-author">
				...
				<div class="about-author-content" style="height:110px"> 
					...
					<p>主要业务：${companyNewsDetail.mainService}</p>
				...
				<ul class="clearfix" style="border:0px">
					<li>
						<article class="clearfix">
							...
							<h6><a href="#">${companyNewsDetail.newsTitle }</a></h6>
						</article>
					</li>
					<li>
						<article class="clearfix">
					...
					<li class="comment depth-1">
						<article class="comment-wrap clearfix">
							...
							<div class="comment-body">
								...
								<p>${companyNewsDetail.newsTitle } </p>
