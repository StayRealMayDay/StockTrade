	...
	<div id="main-content">
		<div class="primary" style="width:780px;float:left">
			<article class="entry-item">
				<header>
					<span class="entry-author">${newsinfo.newsSource }</span>
					<span class="entry-date">&nbsp;&nbsp;|&nbsp;&nbsp;${newsinfo.newsTime}</span>
					<h1 class="entry-title">${newsinfo.newsTitle }</h1>					          
				</header>			
				<blockquote>${newsinfo.newsContent}</blockquote>
			<div class="clear"></div>
			</article>       
				...
				<ul class="clearfix" style="border:0px">
					<li>
						<article class="clearfix">
							...
							<h6><a href="#">${newsinfo.newsTitle }</a></h6>
						</article>
					</li>
					<li>
						<article class="clearfix">
