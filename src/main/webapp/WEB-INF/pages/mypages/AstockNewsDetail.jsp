	...
	<div id="main-content">
		<div class="primary" style="width:780px;float:left">
			<article class="entry-item">
				<header>
					<span class="entry-author">${stockInfo.newsOrigin }</span>
					<span class="entry-date">&nbsp;&nbsp;|&nbsp;&nbsp;${stockInfo.newsTime }</span>
					<h1 class="entry-title">${stockInfo.newsTittle }</h1>					          
				</header>			
				<blockquote>
					${stockInfo.newsContent1 }
					${stockInfo.newsContent2 }
					${stockInfo.newsContent3 }
					${stockInfo.newsContent4 }
					${stockInfo.newsContent5 }
					${stockInfo.newsContent6 }
					${stockInfo.newsContent7 }
				</blockquote>
			<div class="clear"></div>
			</article>       
			<div class="about-author">
				<h3>公司信息</h3>
				<div class="about-author-content" style="height:110px"> 
					<img class="responsive-img" alt="" src="placeholders/avatar/author.png" />
					<p>公司名称：${stockInfo.newsStock1}</p></hr>
					<p>股票代码：${stockInfo.newsStock2}</p>
				...
				<ul class="clearfix" style="border:0px">
					<li>
						<article class="clearfix">
							...
							<h6><a href="#">${stockInfo.newsStock1 }</a></h6>
						</article>
					</li>
					<li>
						<article class="clearfix">
