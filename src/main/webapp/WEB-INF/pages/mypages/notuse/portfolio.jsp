				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<nav class="wthree_nav">
						<ul class="nav navbar-nav nav_1">
							...
							<li class="act"><a href="portfolio.jsp">Portfolio</a></li>
						</ul>
					</nav>
				</div>
			</nav>
			...
			<div class="agileinfo_news_original_grids w3_agile_news_market_grids">
				<div class="col-md-3 agileinfo_portfolio_original_grids_left">
					<div class="portfolio_grid1">
						<a href="single.jsp"><h3>News</h3></a>
						<p>27 August 2016</p>
						<a href="single.jsp"><img src="<%=basePath %>/images/29.jpg" alt=" " class="img-responsive" /></a>
						<div class="portfolio_grid1_anchor">
							<a href="single.jsp">Top 20 chosen stocks of top 10 fund managers that gave up to 80% returns</a>
						</div>
					</div>
					<div class="portfolio_grid1">
						<a href="single.jsp"><h3>News</h3></a>
						<p>28 August 2016</p>
						<a href="single.jsp"><img src="<%=basePath %>/images/30.jpg" alt=" " class="img-responsive" /></a>
						<div class="portfolio_grid1_anchor">
							<a href="single.jsp">Power Ministry plans to set up funds for stressed assets</a>
						</div>
					</div>
					<div class="portfolio_grid1">
						<a href="single.jsp"><h3>News</h3></a>
						<p>28 August 2016</p>
						<a href="single.jsp"><img src="<%=basePath %>/images/18.jpg" alt=" " class="img-responsive" /></a>
						<div class="portfolio_grid1_anchor">
							<a href="single.jsp">Rs 10L crore in 60 days! Look which stocks made the most of the bull run</a>
						</div>
					</div>
					<div class="portfolio_grid1">
						<a href="single.jsp"><h3>News</h3></a>
						<p>29 August 2016</p>
						<a href="single.jsp"><img src="<%=basePath %>/images/31.jpg" alt=" " class="img-responsive" /></a>
						<div class="portfolio_grid1_anchor">
							<a href="single.jsp">Protests outside Chinese embassy in London over Balochistan: How China is involved in the row</a>
						</div>
					</div>
					<div class="portfolio_grid1">
						<a href="single.jsp"><h3>News</h3></a>
						<p>31 August 2016</p>
						<a href="single.jsp"><img src="<%=basePath %>/images/44.jpg" alt=" " class="img-responsive" /></a>
						<div class="portfolio_grid1_anchor">
							<a href="single.jsp">Finally, the BSE Sensex ended with a gain of 120 points at 27,902. The BSE Sensex opened at 27,827 touched an intra-day high of 27,953 and low of 27,699</a>
						</div>
					</div>
				</div>
				<div class="col-md-6 agileinfo_portfolio_original_grids_left1">
					<div class="col-md-6 w3_agile_portfolio_grid1_left">
						<div class="portfolio_grid1">
							<a href="single.jsp"><h3>News</h3></a>
							<p>30 August 2016</p>
							<a href="single.jsp"><img src="<%=basePath %>/images/43.jpg" alt=" " class="img-responsive" /></a>
							<div class="portfolio_grid1_anchor">
								<a href="single.jsp">Shares in Asia mixed as Tokyo jumps on yen, Shanghai down slightly</a>
							</div>
						</div>
						<div class="portfolio_grid1">
							<a href="single.jsp"><h3>News</h3></a>
							<p>30 August 2016</p>
							<a href="single.jsp"><img src="<%=basePath %>/images/28.jpg" alt=" " class="img-responsive" /></a>
							<div class="portfolio_grid1_anchor">
								<a href="single.jsp">Hiving off one of units of Brazilian subsidiary: Shree Renuka</a>
							</div>
						</div>
						<div class="portfolio_grid1">
							<a href="single.jsp"><h3>News</h3></a>
							<p>31 August 2016</p>
							<a href="single.jsp"><img src="<%=basePath %>/images/25.jpg" alt=" " class="img-responsive" /></a>
							<div class="portfolio_grid1_anchor">
								<a href="single.jsp">Expect to close FY17 with revenues of over Rs 1000cr: Sequent</a>
							</div>
						</div>
						<div class="portfolio_grid1">
							<a href="single.jsp"><h3>News</h3></a>
							<p>02 September 2016</p>
							<a href="single.jsp"><img src="<%=basePath %>/images/45.jpg" alt=" " class="img-responsive" /></a>
							<div class="portfolio_grid1_anchor">
								<a href="single.jsp">Real Estate and Construction sector is expected to generate 75 million jobs by 2022: KPMG</a>
							</div>
						</div>
						<div class="portfolio_grid1">
							<a href="single.jsp"><h3>News</h3></a>
							<p>03 September 2016</p>
							<a href="single.jsp"><img src="<%=basePath %>/images/46.jpg" alt=" " class="img-responsive" /></a>
							<div class="portfolio_grid1_anchor">
								<a href="single.jsp">European shares edge lower; Alstom rises on contract win</a>
							</div>
						</div>
					</div>
					<div class="col-md-6 w3_agile_portfolio_grid1_left">
						...
						<div class="portfolio_grid1">
							...
							<a href="single.jsp"><img src="<%=basePath %>/images/47.jpg" alt=" " class="img-responsive" /></a>
							<div class="portfolio_grid1_anchor">
								<a href="single.jsp">Dollar at 3-week high, bonds and stocks sell off on hawkish Fed</a>
							</div>
						</div>
					</div>
					<div class="clearfix"> </div>
