				...
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<table id="datatable1" cellpadding="0" cellspacing="0" border="0"
							...
							<tbody>
								<c:forEach items="${stockinfosDownRi}" var="v" varStatus="sta">
								<tr class="gradeX">
								    <td>${v.stockNum}</td>
									...
									<div class="dataTables_paginate paging_bs_full"
										...
										<ul class="pagination">
											...
											<li ${pager.pageNum==1?'class="disabled"':''}><a
												href="upRatioRank?pageNum=1">首页</a></li>
											<li ${pager.pageNum==1?'class="disabled"':''}><a
												href="upRatioRank?pageNum=${pager.pageNum-1 }">上页</a></li>
											<li ${pager.pageNum==pager.pageCount?'class="disabled"':''}><a
												href="upRatioRank?pageNum=${pager.pageNum+1 }">下页</a></li>
											<li ${pager.pageNum==pager.pageCount?'class="disabled"':''}><a
												href="upRatioRank?pageNum=${pager.pageCount }">末页</a></li>
											<li><a>转到 </a></li>
