	...
	<div id="main-content">
		<div class="primary" style="width:780px;float:left">
			<article class="entry-item">
				<header>
					<span class="entry-author">${csNewsDetail.newsSource }</span>
					<span class="entry-date">&nbsp;&nbsp;|&nbsp;&nbsp;${csNewsDetail.newsTime }</span>
					<h1 class="entry-title">${csNewsDetail.title }</h1>					          
				</header>			
				<blockquote>${csNewsDetail.newsContent }</blockquote>
			<div class="clear"></div>
			</article>       
				...
				<ul class="clearfix" style="border:0px">
					<li>
						<article class="clearfix">
							...
							<h6><a href="#">${csNewsDetail.title }</a></h6>
						</article>
					</li>
					<li>
						<article class="clearfix">
