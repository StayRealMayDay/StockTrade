					...
					<div id="content" class="col-lg-12">
						...
						<nav class="agileinfo_news_original_grids" >
							<ul class="nav nav-tabs nav-tabs1 " style="background-color:#E0F2FA ;width:100%" role="tablist">
								<li style="font-size:18px;width:20%">板块资金</li>
								<li role="presentation" class="active">
									<a href="#brief" id="brief_tab" role="tab" data-toggle="tab" aria-controls="briefTab">行业排名</a>
								</li>
								<li role="presentation">
									<a href="#leader" id="leader_tab" role="tab" data-toggle="tab" aria-controls="leaderTab">地域排名</a>
								</li>
								<li role="presentation">
									<a href="#industry" id="industry_tab" role="tab" data-toggle="tab" aria-controls="industryTab">概念排名</a>
								</li>
							</ul>
						</nav>
						...
						<div id="myTabContent2" class="tab-content">
								...
								<div role="tabpanel" class="tab-pane" id="leader" aria-labelledby="brief_tab">
									<div class="w3l_stocks">
									<div class="box border purple">
										<div class="box-title">
								...
								<div role="tabpanel" class="tab-pane" id="industry" aria-labelledby="brief_tab">
									<div class="w3l_stocks">
									<div class="box border purple">
										<div class="box-title">
