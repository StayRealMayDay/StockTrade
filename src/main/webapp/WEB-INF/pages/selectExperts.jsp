...
<div class="container">
    <div class="single">  
        <div class="col-sm-9 follow_left">
			<c:forEach items="${experts}" var="v">
			<c:set var="string1" value="${v.userRegistTime}"/>
            ...
            <c:set var="string3" value="${fn:substring(string1, 5, 7)}" />
             <div class="jobs_follow jobs-single-item">
				...
				<h6 class="title"><a href="/ventureassess/userDetail?user_uuid=${v.userUuid}">${v.userRealname}</a></h6>
				<span class="meta">${v.userResearch}</span>
				<%-- <ul class="top-btns">
					<li>
                ...
                <a  href="/ventureassess/userDetail?user_uuid=${v.userUuid}" >查看该专家</a>
