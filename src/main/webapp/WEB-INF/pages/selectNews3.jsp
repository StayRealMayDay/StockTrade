...
<div class="container">
    <div class="single">  
        <div class="col-sm-9 follow_left">
			<c:forEach items="${news3}" var="v" begin="0" end="4">
			<c:set var="string1" value="${v.newsTime}"/>
            ...
            <c:set var="string3" value="${fn:substring(string1, 5, 7)}" />
             <div class="jobs_follow jobs-single-item">
				...
				<h6 class="title"><a href="/ventureassess/newsDetail?news_uuid=${v.newsUuid}">${v.newsTitle}</a></h6>
				<span class="meta">${v.newsOrigin}</span>
				<%-- <ul class="top-btns">
					<li>
                ...
                <a href="/ventureassess/newsDetail?news_uuid=${v.newsUuid}">查看该政策法规</a>
