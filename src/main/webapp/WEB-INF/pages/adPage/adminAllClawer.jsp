							...
							<div class="col-sm-12">
								<div class="page-header">
									...
									<ul class="breadcrumb">
										...
										<li><a href="adminAllClawer?pageNum=1">系统资源管理</a></li>
										<li>查看所有爬虫列表</li>
									</ul>
									<!-- /BREADCRUMBS -->
								</div>
						...
						<div id="filter-controls" class="btn-group">
							<form class="form-inline">
								<div class="form-group">
									<label for="projectName">爬虫名称：</label> <input id="projectName"
										type="text" class="form-control" placeholder="爬虫名称">
						...
						<table id="datatable1" cellpadding="0" cellspacing="0" border="0"
							...
							<thead>
								<tr role="row">
									...
									<th class="sorting_asc" role="columnheader" tabindex="0"
										...
										aria-sort="ascending"
										aria-label="Rendering engine: activate to sort column descending"
										style="width: 258.333px;">爬虫名称</th>
									<th class="sorting" role="columnheader" tabindex="0"
										aria-controls="datatable1" rowspan="1" colspan="1"
										aria-label="Browser: activate to sort column ascending"
										style="width: 161.333px;">爬虫请求头信息</th>
									<th class="sorting" role="columnheader" tabindex="0"
										aria-controls="datatable1" rowspan="1" colspan="1"
										aria-label="Browser: activate to sort column ascending"
										style="width: 161.333px;">爬虫相应头信息</th>
									<th class="hidden-xs sorting" role="columnheader" tabindex="0"
										aria-controls="datatable1" rowspan="1" colspan="1"
										aria-label="Platform(s): activate to sort column ascending"
										style="width: 128.333px;">爬取耗时</th>
									<th class="sorting" role="columnheader" tabindex="0"
										aria-controls="datatable1" rowspan="1" colspan="1"
										aria-label="Engine version: activate to sort column ascending"
										style="width: 124.333px;">最近一次爬取时间</th>
									<th class="sorting" role="columnheader" tabindex="0"
										aria-controls="datatable1" rowspan="1" colspan="1"
										aria-label="Engine version: activate to sort column ascending"
										style="width: 164.333px;">下一次爬取时间</th>
									<th class="sorting" role="columnheader" tabindex="0"
										aria-controls="datatable1" rowspan="1" colspan="1"
										aria-label="Engine version: activate to sort column ascending"
										style="width: 114.333px;">查看新闻详情</th>
									<th class="hidden-xs sorting" role="columnheader" tabindex="0"
										aria-controls="datatable1" rowspan="1" colspan="1"
							...
							<!-- <tfoot>
								<tr>
									...
									<th rowspan="1" colspan="1">新闻名称</th>
									<th rowspan="1" colspan="1">来源</th>
									<th rowspan="1" colspan="1">作者</th>
									<th class="hidden-xs" rowspan="1" colspan="1">发布时间</th>
									<th rowspan="1" colspan="1">Engine version</th>
									<th class="hidden-xs" rowspan="1" colspan="1">新闻类型</th>
									<th class="hidden-xs" rowspan="1" colspan="1">新闻热度</th>
									<th class="hidden-xs" rowspan="1" colspan="1">查看新闻详情</th>
									<th class="hidden-xs" rowspan="1" colspan="1">操作</th>
								</tr>
							</tfoot> -->
							<tbody role="alert" aria-live="polite" aria-relevant="all">
								<c:forEach var="anl" items="${allNewsList}" varStatus="">
									<tr class="gradeA odd">
										<td class=" sorting_1"><input type="checkbox"></td>
										<td><a
											href="adminSelectNewsItem?newsUuid=${anl.newsUuid}">${anl.newsTitle}</a></td>
										<td class="hidden-xs ">${anl.newsOrigin}</td>
										<td class="center ">${anl.newsAuthor}</td>
										<td class="center hidden-xs ">${anl.newsTime }</td>
										<td class="center hidden-xs ">${anl.newsType}</td>
										<td class="center hidden-xs ">${anl.newsHot}</td>
										<td class="center hidden-xs "><a
											href="adminSelectNewsItem?newsUuid=${anl.newsUuid}">查看新闻详情</a></td>
										<td class="center hidden-xs "><a title="删除该新闻信息"
											class="btn btn-xs btn-info"
											href="adminDeleteNews?newsUuid=${anl.newsUuid}"
											onclick="deleteUser()">删除</a> <a title="编辑该新闻信息"
											class="btn btn-xs btn-info"
											href="adminEditNews?newsUuid=${anl.newsUuid}"
									...
									<div class="dataTables_paginate paging_bs_full"
										...
										<ul class="pagination">
											...
											<li ${pager.pageNum==1?'class="disabled"':''}><a
												href="adminSelectAllNews?pageNum=1">首页</a></li>
											<li ${pager.pageNum==1?'class="disabled"':''}><a
												href="adminSelectAllNews?pageNum=${pager.pageNum-1 }">上页</a></li>
											<li ${pager.pageNum==pager.pageCount?'class="disabled"':''}><a
												href="adminSelectAllNews?pageNum=${pager.pageNum+1 }">下页</a></li>
											<li ${pager.pageNum==pager.pageCount?'class="disabled"':''}><a
												href="adminSelectAllNews?pageNum=${pager.pageCount }">末页</a></li>
											<li><a>转到 </a></li>
