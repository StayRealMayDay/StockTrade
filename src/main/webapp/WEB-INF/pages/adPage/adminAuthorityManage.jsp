            ...
            <div class="row">
                <div id="content" class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-header">
                                ...
                                <!-- /BREADCRUMBS -->
                                <div class="clearfix">
                                    <h3 class="content-title pull-left">权限分配</h3>
                                </div>
                                <div class="description">动态分配权限</div>
                            </div>
                        </div>
                    </div>
                    <!-- /PAGE HEADER -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <!-- BOX -->
                            <div style="background:#5e87b0;" class="box border">
                                <div class="box-title">
                                    <h4><i class="fa fa-table"></i>权限分配</h4>
                                ...
                                <div class="box-body">
                                    <div id="datatable1_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <label style="margin-left: 60%">用户角色
                                                    <select size="1" name="datatable1_length"
                                                            aria-controls="datatable1"
                                                            class="form-control input-sm">
                                                        <option value="100">所有角色</option>
                                                        <option value="10" selected="selected">项目创建人</option>
                                                        <option value="25">项目投资人</option>
                                                ...
                                                <div class="pull-right">
                                                    ...
                                                    <div class="dataTables_filter" id="datatable1_filter"><label><input
                                                            type="text" aria-controls="datatable1" placeholder="Search"
                                                            class="form-control input-sm"></label></div>
                                                     </div>

                                                <div class="pull-left">
                                                    <div id="datatable1_length" class="dataTables_length"><label>Show
                                                        <select size="1" name="datatable1_length"
                                                                aria-controls="datatable1"
                                                                class="form-control input-sm">
                                        ...
                                        <table id="datatable1" cellpadding="0" cellspacing="0" border="0"
                                            ...
                                            <thead>
                                            <tr role="row">
                                                <th class="sorting_asc" role="columnheade
                                                ...
                                                r" tabindex="0"
                                                    ...
                                                    style="width: 258.333px;">模块名称
                                                </th>
                                                <th class="sorting" role="columnheader" tabindex="0"
                                                    aria-controls="datatable1" rowspan="1" colspan="1"
                                                    aria-label="Browser: activate to sort column ascending"
                                                    style="width: 361.333px;">增加权限
                                                </th>
                                                <th class="hidden-xs sorting" role="columnheader" tabindex="0"
                                                    aria-controls="datatable1" rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
                                                    style="width: 328.333px;">删除权限
                                                </th>
                                                <th class="sorting" role="columnheader" tabindex="0"
                                                    aria-controls="datatable1" rowspan="1" colspan="1"
                                                    aria-label="Engine version: activate to sort column ascending"
                                                    style="width: 224.333px;">编辑权限
                                                </th>
                                                <th class="hidden-xs sorting" role="columnheader" tabindex="0"
                                                    aria-controls="datatable1" rowspan="1" colspan="1"
                                                    aria-label="CSS grade: activate to sort column ascending"
                                                    style="width: 168.333px;">查看权限
                                                </th>
                                            </tr>
                                            </thead>
                                            ...
                                            <tfoot>
                                            <tr>
                                                <th rowspan="1" colspan="1">模块名称</th>
                                                <th rowspan="1" colspan="1">增加权限</th>

                                                <th rowspan="1" colspan="1">删除权限</th>
                                                <th class="hidden-xs" rowspan="1" colspan="1">编辑权限</th>
                                                <!--<th rowspan="1" colspan="1">Engine version</th>-->
                                                <th class="hidden-xs" rowspan="1" colspan="1">查看权限</th>
                                            </tr>
                                            </tfoot>
                                            <tbody role="alert" aria-live="polite" aria-relevant="all">
                                            <tr class="gradeA odd">
                                                <td class=" sorting_1">项目模块</td>
                                                <td class=" "><div class="make-switch switch-small" data-on="warning" data-off="danger">
                                                    <input type="checkbox">
                                                </div></td>
                                                <td class="hidden-xs "><div class="make-switch switch-small" data-on="warning" data-off="danger">
                                                    <input type="checkbox">
                                                </div></td>
                                                <td class="center "><div class="make-switch switch-small" data-on="warning" data-off="danger">
                                                    <input type="checkbox">
                                                </div></td>
                                                <td class="center hidden-xs "><div class="make-switch switch-small" data-on="warning" data-off="danger">
                                                    <input type="checkbox">
                                                </div></td>
                                            </tr>
                                            <tr class="gradeA even">
                                                <td class=" sorting_1">团队</td>
