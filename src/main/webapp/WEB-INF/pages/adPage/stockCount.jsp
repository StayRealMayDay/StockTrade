								...
								<div class="row">
									<div class="col-md-12">
										<div class="box border purple">
											<div class="box-title">
												<h4><i class="fa fa-bars"></i>股票数量统计</h4>
													...
													<div class="dashbox panel panel-default">
														<div class="panel-body">
															...
															<div class="panel-right">
																<div class="number">${stock_num}</div>
																<div class="title">数据库股票总量</div>
												...
												<div class="col-lg-6" style="width:350px;margin-left:30px;margin-top:30px;margin-bottom:30px">
													<div class="dashbox panel panel-default">
														<div class="panel-body">
															...
															<div class="panel-right">
																<div class="number">${today_stock}</div>
																<div class="title">今日新增股票总量</div>
												...
												<div class="col-lg-6" style="width:350px;margin-left:30px;margin-top:30px;margin-bottom:30px">
													<div class="dashbox panel panel-default">
														<div class="panel-body">
															...
															<div class="panel-right">
																<div class="number">${weekly_stock}</div>
																<div class="title">最近一周股票爬取量</div>
												...
												<div class="col-lg-6" style="width:350px;margin-left:30px;margin-top:30px;margin-bottom:30px">
													<div class="dashbox panel panel-default">
														<div class="panel-body">
															...
															<div class="panel-right">
																<div class="number">${monthly_stock}</div>
																<div class="title">最近一月股票爬取量</div>
