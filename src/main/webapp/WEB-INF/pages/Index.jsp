...
<html lang="en">
    <head>
		...
		<!-- 增加 -->
		<link href="<%= basePath%>/static/adStyle/global/css/bootstrap-responsive.css" rel="stylesheet" media="screen">
    ...
    <body data-scrolling-animations="true">
                    ...
                    <div class="sp-slides">
                        <div class="slide-item sp-slide">
                            ...
                            <div class="slide-content ">
                                <p class="top-title sp-layer"  data-show-transition="left" data-hide-transition="up" data-show-delay="400" data-hide-delay="100" >we are venture assess</p>
                                ...
                                <div class="controls sp-layer" data-show-transition="up" data-hide-transition="up" data-show-delay="800" data-hide-delay="250">
                                    <a href="/ventureassess/toLogin" class="btn btn-primary">Get Started NOW</a>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        <div class="service-item">
                            ...
                            <div class="media-body">
                                ...
                                <p ><a href="/ventureassess/selectNews1"><img src="<%= basePath%>/static/adStyle/global/img/more.gif"></a></p>
                                <p>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        <div class="service-item">
                            ...
                            <div class="media-body">
                                ...
                                <p ><a href="/ventureassess/selectExperts"><img src="<%= basePath%>/static/adStyle/global/img/more.gif"></a></p>
                                <p>
                                	<ul class="tz_list listr">
										 <c:forEach items="${experts}" var="v" begin="0" end="2">
										<li><a title="${v.userRealname} ${v.userEdu} ${v.userResearch}方向"
											href="/ventureassess/userDetail?user_uuid=${v.userUuid}">${v.userRealname} ${v.userEdu} ${v.userResearch}方向</a>
										</li>
			                          </c:forEach>
									</ul>
                                </p>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        <div class="service-item">
                            ...
                            <div class="media-body">
                                ...
                                <p ><a href="/ventureassess/selectReq"><img src="<%= basePath%>/static/adStyle/global/img/more.gif"></a></p>
                                <p>
                                	<ul class="tz_list">
										<c:forEach items="${reqs}" var="v" begin="0" end="2">
										<li><a title="${v.reqName} (${v.reqBrief}) "
											href="/ventureassess/reqDetail?req_uuid=${v.reqUuid}">${v.reqName} (${v.reqBrief})</a>
										</li>
										</c:forEach>
									</ul>
                                </p>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        <div class="service-item">
                            ...
                            <div class="media-body">
                                <h4>行业动态</h4>
                                <!-- <p><em>providing excellent services</em></p> -->
                                <p ><a href="/ventureassess/selectNews2"><img src="<%= basePath%>/static/adStyle/global/img/more.gif"></a></p>
                                <p>
                                	<ul class="tz_list listr">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        <div class="service-item">
                            ...
                            <div class="media-body">
                                <h4>政策法规</h4>
                                <!-- <p><em>best solutions that works</em></p> -->
                                <p ><a href="/ventureassess/selectNews3"><img src="<%= basePath%>/static/adStyle/global/img/more.gif"></a></p>
                                <p>
                                	<ul class="tz_list listr">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        <div class="service-item">
                            ...
                            <div class="media-body">
                                <h4>成果预览</h4>
                                <!-- <p><em>lorem ipsum dolor sit amet</em></p> -->
                                <p ><a href="/ventureassess/selectPros"><img src="<%= basePath%>/static/adStyle/global/img/more.gif"></a></p>
                                <p>
                                	<ul class="tz_list listr">
        ...
        <footer>
            ...
            <section class="copyright-section">
                <p>Copyright &copy; 2017.Company name All rights reserved.<a target="_blank" href="/ventureassess/Index">风险投资评估系统</a></p>
            </section>
        </footer>
