...
<body class="login"
	style="background-image: url('<%= basePath%>/static/adStyle/img/1.jpg')">
	<!-- PAGE -->
	<section id="page">
		<!-- HEADER -->
		<header>
					...
					<div class="col-md-4 col-md-offset-4">
						<div id="logo">
							<a href="index.html"><img
								src="<%= basePath%>/static/adStyle/img/logo/logo-alt.png"
