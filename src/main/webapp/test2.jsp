...
<body>
    ...
    <div id="industry" style="width: 1200px;height:1200px;border:1px;align:center;"></div>
 ...
 */
        ...
        function randomData() {
 		...
 		$.getJSON('http://localhost:8080/Stock-Trade/getIndusDistri', function (json) {
    ...
    <form action="/Stock-Trade/setIndusDistri">
       <button type="submit">行业分布</button>
    </form>
</body>
</html>