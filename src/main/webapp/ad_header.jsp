    ...
    <div class="container">
        <div class="navbar-brand">
            ...
            <a style="text-decoration: none" href="index.html">
                <h3 style="color: white;margin-left: 10%">股票交易平台</h3>
            </a>
            <!-- /COMPANY LOGO -->
        ...
        <ul class="nav navbar-nav pull-right">
            ...
            <li class="dropdown" id="header-message">
                ...
                <ul class="dropdown-menu inbox">
                    ...
                    <li>
                        <a href="#">
                            <img src="<%= basePath%>/static/adStyle/img/avatars/avatar2.jpg" alt=""/>
									<span class="body">
                    ...
                    <li>
                        <a href="#">
                            <img src="<%= basePath%>/static/adStyle/img/avatars/avatar1.jpg" alt=""/>
									<span class="body">
                    ...
                    <li>
                        <a href="#">
                            <img src="<%= basePath%>/static/adStyle/img/avatars/avatar8.jpg" alt=""/>
									<span class="body">
            ...
            <li class="dropdown user" id="header-user">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img alt="" src="<%= basePath%>/static/adStyle/img/avatars/avatar3.jpg"/>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a  title="退出系统" href="/ventureassess/adminLoginOut"><i class="fa fa-power-off"></i> 退出系统</a></li>
                </ul>
            </li>
        ...
        <div id="teamslider">
            <ul class="team-list">
                <li class="current">
				  ...
				  <span class="image">
					  <img src="<%= basePath%>/static/adStyle/img/avatars/avatar3.jpg" alt=""/>
				  </span>
				  <span class="title">
					You
				  </span>
                ...
                <li>
                    <a href="javascript:void(0);">
				  <span class="image">
					  <img src="<%= basePath%>/static/adStyle/img/avatars/avatar4.jpg" alt=""/>
				  </span>
				  <span class="title">
					Ellie Doe
				  </span>
                ...
                <li>
                    <a href="javascript:void(0);">
				  <span class="image">
					  <img src="<%= basePath%>/static/adStyle/img/avatars/avatar5.jpg" alt=""/>
				  </span>
				  <span class="title">
					Lisa Doe
				  </span>
                ...
                <li>
                    <a href="javascript:void(0);">
				  <span class="image">
					  <img src="<%= basePath%>/static/adStyle/img/avatars/avatar6.jpg" alt=""/>
				  </span>
				  <span class="title">
					Kelly Doe
				  </span>
                ...
                <li>
                    <a href="javascript:void(0);">
				  <span class="image">
					  <img src="<%= basePath%>/static/adStyle/img/avatars/avatar7.jpg" alt=""/>
				  </span>
				  <span class="title">
					Jessy Doe
				  </span>
