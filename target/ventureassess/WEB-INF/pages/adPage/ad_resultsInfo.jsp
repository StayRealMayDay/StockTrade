							...
							<div class="control-group form-group">
								<div class="controls">
									<label class="contact-p1">成果名称:</label> <input
										value="${result.res_name}" readonly="readonly" type="text"
										class="form-control" name="res_name" id="p_name"
										onblur="checkPname()" required
								...
								<div class="controls">
									<label class="contact-p1">成果评估值:</label> <input
										value="${result.res_evalue}" readonly="readonly" type="text"
										class="form-control" name="res_evalue" id="p_name"
										onblur="checkPname()" required
										data-validation-required-message="Please enter your name.">
									<label id="validate_pname"
										style="font-size: 9px; display: none;"></label>
								...
								<div class="controls">
									<label class="contact-p1">成果提供者:</label>
									<%--<select
									class="form-control" id="user_name" name="res_provider"> <c:forEach items="${listUsers}" var="listUsers">
									...
									<c:forEach items="${listUsers}" var="listUsers">
										<c:if test="${listUsers.user_id==result.res_provider}">
											<input value="${listUsers.user_name}" readonly="readonly"
												type="text" class="form-control" name="res_provider"
												id="res_provider" onblur="checkPname()" required
												data-validation-required-message="Please enter your name.">
										</c:if>
									</c:forEach>
									<label id="validate_pname"
								...
								<div class="controls">
									...
									<c:if test="${result.res_flag==1}">
										<input value="待评估" type="text" readonly="readonly"
											class="form-control" name="res_flag" id="p_name"
											onblur="checkPname()" required
											data-validation-required-message="Please enter your name.">
									</c:if>
									<c:if test="${result.res_flag==2}">
										<input value="评估截止" type="text" readonly="readonly"
											class="form-control" name="res_flag" id="p_name"
											onblur="checkPname()" required
											data-validation-required-message="Please enter your name.">
									</c:if>
								...
								<div class="controls">
									<label class="contact-p1">评估的截止时间:</label> <input
										...
										readonly="readonly" class="form-control Wdate"
									...
									<div class="control-group form-group">
										<div class="controls">
											<label class="contact-p1">论文名称:</label> <input
												value="${paper.paper_name}" type="text" readonly="readonly"
									...
									<div class="control-group form-group">
										<div class="controls">
											<label class="contact-p1">被引用次数:</label> <input
												value="${paper.paper_cited}" type="text" readonly="readonly"
												class="form-control" name="p_cited" id="p_cited"
												onblur="checkCited()" required
												data-validation-required-message="Please enter your name.">
											<label id="validate_cited"
												style="font-size: 9px; display: none;"></label>
											<p class="help-block"></p>
										</div>
									</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 contact-agile2">
									<div class="control-group form-group">
										<div class="controls">
											...
											<c:forEach items="${journals}" var="journals">
												<c:if test="${journals.j_id==paper.published_journals }">
													<input value="${journals.j_name}" readonly="readonly"
														type="text" class="form-control" name="p_publications"
														id="res_provider" onblur="checkPname()" required
														data-validation-required-message="Please enter your name.">
												</c:if>
											</c:forEach>
									...
									<div class="control-group form-group">
										<div class="controls">
											...
											<c:if test="${paper.paper_category==1}">
												<input value="SCI(科学引文索引)" type="text" readonly="readonly"
													class="form-control" name="p_category" id="p_cited"
													onblur="checkCited()" required
													data-validation-required-message="Please enter your name.">
											</c:if>
											<c:if test="${paper.paper_category==2}">
												<input value="EI(工程索引)" type="text" readonly="readonly"
													class="form-control" name="p_category" id="p_cited"
													onblur="checkCited()" required
													data-validation-required-message="Please enter your name.">
											</c:if>
											<c:if test="${paper.paper_category==3}">
												<input value="ISTP(科技会议录索引)" type="text" readonly="readonly"
													class="form-control" name="p_category" id="p_cited"
													onblur="checkCited()" required
													data-validation-required-message="Please enter your name.">
											</c:if>
											<c:if test="${paper.paper_category==4}">
												<input value="其他" type="text" readonly="readonly"
													class="form-control" name="p_category" id="p_cited"
													onblur="checkCited()" required
													data-validation-required-message="Please enter your name.">
											</c:if>
									...
									<div class="control-group form-group">
										<div class="controls">
											<label class="contact-p1">论文附件:</label> <input
												...
												readonly="readonly" class="form-control" name="p_cited"
												id="p_cited" onblur="checkCited()" required
												data-validation-required-message="Please enter your name.">
								...
								<div class="col-lg-12">
									<div class="control-group form-group">
										<div class="controls">
											...
											<textarea readonly="readonly" value="${paper.paper_remark}"
												rows="10" cols="100" class="form-control"
												name="p_introduction" id="p_introduction" required
								...
								<div class="col-lg-6 col-md-6 col-sm-6 contact-agile1">
									...
									<div class="control-group form-group">
										<div class="controls">
											<label class="contact-p1">专利名称:</label> <input
												value="${patent.pa_name}" type="text" readonly="readonly"
												class="form-control" name="pa_name" id="pa_name"
												onblur="checkPaname()" required
												data-validation-required-message="Please enter your name.">
											<label id="validate_paname"
												style="font-size: 9px; display: none;"></label>
											<p class="help-block"></p>
										</div>
									</div>
									<div class="control-group form-group">
										<div class="controls">
											...
											<c:if test="${patent.pa_type==1 }">
												<input value="发明类(产品)" type="text" readonly="readonly"
													class="form-control" name="pa_type" id="pa_type"
													onblur="checkPaname()" required
													data-validation-required-message="Please enter your name.">
											</c:if>
											<c:if test="${patent.pa_type==2 }">
												<input value="发明类(方法)" type="text" readonly="readonly"
													class="form-control" name="pa_type" id="pa_type"
													onblur="checkPaname()" required
													data-validation-required-message="Please enter your name.">
											</c:if>
											<c:if test="${patent.pa_type==3 }">
												<input value="外观设计类" type="text" readonly="readonly"
													class="form-control" name="pa_type" id="pa_type"
													onblur="checkPaname()" required
													data-validation-required-message="Please enter your name.">
											</c:if>
									...
									<div class="control-group form-group">
										<div class="controls">
											...
											<c:forEach items="${listUsers}" var="listUsers">
												<c:if test="${listUsers.user_id==result.res_provider}">
													<input value="${listUsers.user_name}" type="text"
														readonly="readonly" class="form-control"
														name="pa_inventor" id="pa_type" onblur="checkPaname()"
														required
														data-validation-required-message="Please enter your name.">
												</c:if>
											</c:forEach>
									...
									<div class="control-group form-group">
										<div class="controls">
											<label class="contact-p1">申请时间:</label> <input
												value="${patent.pa_pubtime}" type="text" readonly="readonly"
                           ...
                           <input type="text" class="form-control" name="pa_pubtime" id="pa_pubtime" required data-validation-required-message="Please enter your email address.">
									...
									<div class="control-group form-group">
										<div class="controls">
											<label class="contact-p1">专利号:</label> <input
												value="${patent.pa_number}" type="text" readonly="readonly"
												class="form-control" name="pa_number" id="pa_number"
												required
							...
							<div id="softwareResults">
								...
								<div class="col-lg-6 col-md-6 col-sm-6 contact-agile1">
									<div class="control-group form-group">
										<div class="controls">
											<label class="contact-p1">软件名称:</label> <input
												value="${software.s_name}" type="text" readonly="readonly"
												class="form-control" name="s_name" id="s_name"
												onblur="checkSname()" required
												data-validation-required-message="Please enter your name.">
									...
									<div class="control-group form-group">
										<div class="controls">
											<label class="contact-p1">是否发布(在某应用商店或平台):</label>
											<%-- <select
											...
											<c:if test="${software.s_ispublished==1}">
												<input value="发布" type="text" readonly="readonly"
													class="form-control" name="s_ispublished"
													id="s_ispublished" onblur="checkSname()" required
													data-validation-required-message="Please enter your name.">
											</c:if>
											<c:if test="${software.s_ispublished==0}">
												<input value="未发布" type="text" readonly="readonly"
													class="form-control" name="s_ispublished"
													id="s_ispublished" onblur="checkSname()" required
													data-validation-required-message="Please enter your name.">
											</c:if>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 contact-agile2">
									<div class="control-group form-group">
										<div class="controls">
											...
											<c:if test="${software.s_level==1}">
												<input value="高度可移植性(任何平台或环境都可以运行)" type="text"
													readonly="readonly" class="form-control Wdate"
													onFocus="WdatePicker({lang:'zh-cn',maxDate:new Date()})"
													name="s_level" id="s_level" style="height: 40px" />
											</c:if>
											<c:if test="${software.s_level==2}">
												<input value="较好的可移植性(大多数平台或环境都可以运行)" type="text"
													readonly="readonly" class="form-control Wdate"
													onFocus="WdatePicker({lang:'zh-cn',maxDate:new Date()})"
													name="s_level" id="s_level" style="height: 40px" />
											</c:if>
											<c:if test="${software.s_level==3}">
												<input value="一般的可移植性(少数平台或环境)" type="text"
													readonly="readonly" class="form-control Wdate"
													onFocus="WdatePicker({lang:'zh-cn',maxDate:new Date()})"
													name="s_level" id="s_level" style="height: 40px" />
											</c:if>
											<c:if test="${software.s_level==4}">
												<input value="较差的可移植性(只针对一两种平台或环境)" type="text"
													readonly="readonly" class="form-control Wdate"
													onFocus="WdatePicker({lang:'zh-cn',maxDate:new Date()})"
													name="s_level" id="s_level" style="height: 40px" />
											</c:if>
									...
									<div class="control-group form-group">
										<div class="controls">
											...
											<c:if test="${software.s_ccm==1}">
												<input value="软件实现的功能完全满足软件计划书中要求的" type="text"
													readonly="readonly" class="form-control Wdate"
													onFocus="WdatePicker({lang:'zh-cn',maxDate:new Date()})"
													name="s_ccm" id="s_ccm" style="height: 40px" />
											</c:if>
											<c:if test="${software.s_ccm==2}">
												<input value="基本满足完备性" type="text" readonly="readonly"
													class="form-control Wdate"
													onFocus="WdatePicker({lang:'zh-cn',maxDate:new Date()})"
													name="s_ccm" id="s_ccm" style="height: 40px" />
											</c:if>
											<c:if test="${software.s_ccm==3}">
												<input value="有少量功能没有实现" type="text" readonly="readonly"
													class="form-control Wdate"
													onFocus="WdatePicker({lang:'zh-cn',maxDate:new Date()})"
													name="s_ccm" id="s_ccm" style="height: 40px" />
											</c:if>
									...
									<div class="control-group form-group">
										<div class="controls">
											<label class="contact-p1">软件附件:</label> <input type="text"
												readonly="readonly" value="${upload.upload_name}"
												class="form-control" name="p_cited" id="p_cited"
												onblur="checkCited()" required
												data-validation-required-message="Please enter your name.">
											<!-- <input type="file" name="file3"
								...
								<div class="col-lg-12">
									<div class="control-group form-group">
										<div class="controls">
											...
											<textarea readonly="readonly" value="${software.s_brief}"
												rows="10" cols="100" class="form-control" name="s_brief"
												id="s_brief" required
												data-validation-required-message="Please enter your introduction"
												maxlength="999" style="resize: none"></textarea>
											<p class="help-block"></p>
							...
							<div id="protoTypeResults">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" readonly="readonly"
											value="${result.res_name}" class="form-control"
											name="pt_name" id="pt_name" onblur="checkPtname()"
											placeholder="请输入样机名称..."> <label id="validate_ptname"
											style="font-size: 9px; display: none;"></label>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<c:if test="${prototype.pt_entity==0}">
											<input type="text" readonly="readonly" value="无样机，有设计图"
												class="form-control" name="pt_entity" id="pt_entity"
												onblur="checkPtname()" placeholder="请输入样机名称...">
										</c:if>
										<c:if test="${prototype.pt_entity==1}">
											<input type="text" readonly="readonly" value="有样机"
												class="form-control" name="pt_entity" id="pt_entity"
												onblur="checkPtname()" placeholder="请输入样机名称...">
										</c:if>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<div class="input-group">
											<input type="text" readonly="readonly"
												value="${prototype.pt_price}" class="form-control"
												name="pt_price" id="pt_price" onblur="checkNumber()"
												placeholder="请输入预期价格...">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<c:if test="${prototype.pt_safety==1}">
											<input type="text" readonly="readonly"
												value="属于食品行业，对安全属性要求最高" class="form-control"
												name="pt_safety" id="pt_safety" onblur="checkPtname()"
												placeholder="请输入样机名称...">
										</c:if>
										<c:if test="${prototype.pt_safety==2}">
											<input type="text" readonly="readonly"
												value="属于其他对安全属性要求较高的领域" class="form-control"
												name="pt_safety" id="pt_safety" onblur="checkPtname()"
												placeholder="请输入样机名称...">
										</c:if>
										<c:if test="${prototype.pt_safety==3}">
											<input type="text" readonly="readonly" value=" 不属于安全性要求高的领域"
												class="form-control" name="pt_safety" id="pt_safety"
												onblur="checkPtname()" placeholder="请输入样机名称...">
										</c:if>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select class="form-control" name="pt_aimgroup"
											id="pt_aimgroup" disabled="disabled">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" readonly="readonly"
											class="form-control Wdate" value="${result.res_eva_deadline}"
								...
								<h3>
									<a class="btn radius btn-gray"
										href="/vcevaluation/editPaper?res_id=${result.res_id}">继续编辑</a>
									&nbsp;&nbsp;&nbsp;&nbsp; <a class="btn radius btn-gray" href="#"><span
										onclick="javascript:history.go(-2);">返回页面</span></a>
								</h3>
							</div>
