	...
	<div class="page-wrapper">
		...
		<div class="container">
			<div class="row">
				...
				<h3>
				      <a class="btn radius btn-gray" href="/vcevaluation/ad_editUserInfo?user_id=${user.user_id}">编辑</a>
				      &nbsp;&nbsp;
				      <a class="btn radius btn-gray" href="/vcevaluation/ad_userManage"><span  onclick="javascript:history.go(-1);" >返回</span></a>
				</h3>
				</div>
