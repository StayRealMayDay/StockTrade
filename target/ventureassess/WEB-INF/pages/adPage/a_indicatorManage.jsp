...
<body>
	...
	<div class="page-wrapper">
               ...
               <jsp:include page="/ad_left.jsp" flush="true" />
				...
				<div class="main col-md-8 col-md-offset-1">
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											...
											<h4 class="modal-title" id="myModalLabel">新增样机评估指标</h4>
										</div>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											...
											<h4 class="modal-title" id="myModalLabel1">编辑样机评估指标</h4>
										</div>
										<div class="modal-body">
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											...
											<h4 class="modal-title" id="myModalLabel2">编辑样机评估指标</h4>
										</div>
										<div class="modal-body">
									...
									<li id="item_${status.index+1}" class="item_a"
										...
										<div>
											...
											<button
												...
												style="background: transparent; color: red; border: 0px; font-size: 16px; padding: 0px"
												type="button" class="btn btn-primary btn-sm"
												id="deleteFather${in.in_id}"  onclick="deletefirstIn(this.id)" href="deleteIndicator?pageNum=${pager.pageNum}&in_id=${in.in_id}">删除指标</a>
											<!--  <input
														...
														<div>
															...
															<button
															   ...
															   <a
																style="background: transparent; color: red; border: 0px; font-size: 14px; padding: 0px"
																type="button" class="btn btn-primary btn-sm"
																id="deleteChild${inNext.in_id}" onclick="deleteNextIn(this.id)" href="deleteIndicator?pageNum=${pager.pageNum}&in_id=${inNext.in_id}" >删除指标</a>	
																<a
																style="background: transparent; color: red; border: 0px; font-size: 14px; padding: 0px"
																type="button" class="btn btn-primary btn-sm"
					...
					<ul class="pagination">
									...
									<li ${pager.pageNum==1?'class="disabled"':''}><a href="selectIndexFactor?pageNum=1">首页</a></li>
									<li ${pager.pageNum==1?'class="disabled"':''}><a href="selectIndexFactor?pageNum=${pager.pageNum-1 }">上页</a></li>		
									<li ${pager.pageNum==pager.pageCount?'class="disabled"':''}><a href="selectIndexFactor?pageNum=${pager.pageNum+1 }">下页</a></li>
									<li ${pager.pageNum==pager.pageCount?'class="disabled"':''}><a href="selectIndexFactor?pageNum=${pager.pageCount }">末页</a></li>
		...
		<script type="text/javascript">
		 ...
		 function deleteNextIn(id) {
			 var in_id = id.substring(id.indexOf('deleteChild')+11);
			 
			 var a = confirm("确定要删除这个二级指标吗？");
				if (a == true) {
					//return true; 
					var href=document.getElementById(id).href;
					window.open(href);
