...
<body>
	...
	<div class="page-wrapper">
		...
		<div class="container">
			...
			<form action="addSoftware1"  method="post"  Content-Range="bytes 0-800/801" enctype="multipart/form-data">
				...
				<div class="col-lg-12">	
                    ...
                    <button type="submit" class="btn btn-default" style="margin-left:40%;width:210px;">软件提交</button>
				</div>
