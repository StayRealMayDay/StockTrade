           ...
           <div class="space-bottom"></div>
            ...
            <form id="form1" class="form-horizontal" name="form1" method="post" action="">
		      ...
		      <div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" name="ps_way" id="ps_way" placeholder="请输入样机名称...">
				</div>
		      </div>
		      <div class="form-group">
				<label class="col-sm-2 control-label">支持级别</label>
				<div class="col-sm-8">
					<input type="text" class="form-control" name="ps_rank" id="ps_rank" placeholder="请输入样机名称...">
				</div>
		      </div>
		      <div class="form-group">
				<label class="col-sm-2 control-label">支持类别</label>
				<div class="col-sm-8">
					<input type="text" class="form-control" name="ps_category" id="ps_category" placeholder="请输入样机名称...">
				</div>
		      </div>
