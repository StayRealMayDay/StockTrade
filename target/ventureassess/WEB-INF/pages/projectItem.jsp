						...
						<div class="main col-md-12">
							...
							<div class="row">
							    ...
							    <%if(user.getUser_type()==0){%>
									...
									<a href="/vcevaluation/toEva_project?pro_id=${pro.pro_id}" class="btn btn-white margin-top-clear">开始评估项目</a>
							...
							<table class="table table-bordered table-striped">
				              ...
				              <tr>
				                ...
				                <c:if test="${team.member_gender==1}">	
				                <td>男</td>
				                </c:if>
				                <c:if test="${team.member_gender==2}">	
				                <td>女</td>
				                </c:if>
				                <c:if test="${team.member_edu==1}">	
				                <td>博士</td>
				                </c:if>
				                <c:if test="${team.member_edu==2}">	
				                <td>硕士</td>
				                </c:if>
				                <c:if test="${team.member_edu==3}">	
				                <td>本科</td>
				                </c:if>
				                <c:if test="${team.member_edu==4}">	
				                <td>本科以下</td>
				                </c:if>
				                <td>${team.member_job }</td>
							...
							<table class="table table-bordered table-striped">
				              <tr>
				               ...
				               <c:forEach items="${ppsList}" var="pps">
				              <tr>
				               
				                <td>${pps.pro_ps_name }</td>
				                <td>${pps.ps_way }</td>
				                <td>${pps.ps_rank}</td>
				                <td>${pps.ps_category }</td>
				                <td>${pps.fund }</td> 
