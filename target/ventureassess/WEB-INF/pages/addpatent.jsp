...
<section class="contact-w3ls">
	<div class="container">
		...
		<h2 class="text-center title">专利提交</h2>
			...
			<form action="upload2" method="post"  Content-Range="bytes 0-800/801" enctype="multipart/form-data" onsubmit="return validation();" >
				...
				<div class="col-lg-6 col-md-6 col-sm-6 contact-agile2">
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
						 ...
						 <input type="file" name="file2" id="file2" style="height:34px;width:200px">
							<p class="help-block"></p>
						</div>
                    </div>
				</div>
