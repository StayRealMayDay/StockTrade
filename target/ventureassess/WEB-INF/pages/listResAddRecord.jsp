					...
					<div class="container">
						<div class="row">
							...
							<div class="main col-md-10">
								...
								<!-- page-title start -->
								<!-- ================ -->
								<h3 class="page-title">成果新增评估记录</h3>
									...
									<tbody>
										<c:forEach items="${evas}" var="eva">
											<tr>
												...
												<c:if test="${res.res_flag==1}">
												<td>待评估</td>
												<td>无结果</td>
												</c:if>
												<c:if test="${res.res_flag==2}">
												<td>评估截至</td>
												   <c:if test="${res.res_evalue >= 8}">
												...
												<td>${ res.res_times}</td>
												<td>${ res.res_evalue}</td>
												<td><a class="" href="/vcevaluation/resultItem?res_id=${res.res_id}">成果详情</a><br>
												</td>
											</tr>
