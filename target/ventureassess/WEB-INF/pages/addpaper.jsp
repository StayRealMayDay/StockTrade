...
<section class="contact-w3ls">
	...
	<div class="container">
		...
		<h2 class="text-center title">论文提交</h2>
			...
			<form id="form1" role="form" action="upload1" method="post"  Content-Range="bytes 0-800/801" enctype="multipart/form-data" onsubmit="return validation();" >
				...
				<div class="col-lg-6 col-md-6 col-sm-6 contact-agile2">
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
						 ...
						 <input type="file" name="file1" id="file1" style="height:34px;width:200px">
							<p class="help-block"></p>
						</div>
                    </div>
				</div>
...
function validation(){
	if(checkCited() && checkPname()&&checkFile()){
		return true;
	}else{
		return false;
	}
