							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse" id="navbar-collapse-1" >
									<ul class="nav navbar-nav navbar-right">
															...
															<div class="row">
																...
																<div class="col-sm-4">
																	...
																	<!-- 基金经理：0； -->
																		<ul class="menu">
																			...
																			<li><a href="/vcevaluation/toaddprototype"><i class="icon-right-open"></i>创建样机</a></li>
																...
																<div class="col-sm-4">
																	...
																	<ul class="menu">
																		...
																		<li><a href="/vcevaluation/selectAllPrototype?pageNum=1"><i class="icon-right-open"></i>查询全部样机</a></li>
										...
										<li class="dropdown">
											<a href="toAddmember?pageNum=1" class="dropdown-toggle" data-toggle="dropdown">成员管理</a>
											<ul class="dropdown-menu">
												<li><a href="/vcevaluation/toAddmember?pageNum=1">成员管理</a></li>
											</ul>
										</li>
										<li class="dropdown">
											<a href="/vcevaluation/userInfo" class="dropdown-toggle" data-toggle="dropdown">个人中心</a>
											<ul class="dropdown-menu">
